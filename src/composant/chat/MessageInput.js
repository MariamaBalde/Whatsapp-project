export function createMessageInput() {
    ...
    inputContainer.className = 'bg-[#202c33] px-4 py-2 flex items-center space-x-4';
    
    inputContainer.innerHTML = `
        <button class="p-2 text-[#8696a0] hover:bg-[#374045] rounded-full">
        ...
        <input type="text" 
               ...
               class="flex-1 bg-[#2a3942] text-[#d1d7db] placeholder-[#8696a0] px-4 py-2 rounded-lg focus:outline-none">
        <button class="p-2 text-[#8696a0] hover:bg-[#374045] rounded-full">
            <svg viewBox="0 0 24 24" width="24" height="24">
